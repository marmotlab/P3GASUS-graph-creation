...
def getOneEpData(NUM_AGENTS, FPS, index):
    ...
    # Fname = "tanishq_coin/paths/agents"+str(NUM_AGENTS)+"_fps"+str(FPS)
    Fname = "{}Agents_{}fps".format(NUM_AGENTS, FPS)
...
for (NUM_AGENTS, FPS) in pairsLeft:
    ...
    missing_numbers = [num for num in range(2) if num not in existing_numbers]
